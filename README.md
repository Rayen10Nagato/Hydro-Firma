...
Farm Unit (IoT Node)
Central Hub (Raspberry Pi + Node-RED)
Plant Health Monitoring System (Camera-Based)
...
Raspberry Pi OS flashed on an SD card.
...
Farm Unit Firmware (Room_Unit.ino):
...
Central Hub Setup (Raspberry Pi):
Install MQTT Broker:
...
Deploy the flow.
8. Usage
Power on both the Farm Unit and the Central Hub.
The Farm Unit will begin collecting sensor data and transmitting it via LoRa.
The LoRa-MQTT bridge on the Raspberry Pi will receive the data and publish it to the appropriate MQTT topics.
Open the Node-RED dashboard in your browser (http://<RASPBERRY_PI_IP>:1880/ui) to see real-time data visualizations and control the actuators.
...
12. Acknowledgments
We would like to extend our gratitude to the organizers of the P2E Challenge TSYP 13, as well as our mentors and partners at IEEE Tunisia Section and Orange Digital Center for their invaluable support, resources, and guidance throughout this project.# Hydro-Firma
Hydro Firma is a smart hydroponic farming solution. The system integrates IoT, LoRa communication, Node-RED dashboards, and computer vision to monitor and manage hydroponic farms efficiently.
